...
class MainForm:
    def __init__(self):
        ...
        self.root.geometry("415x280+400+200")#窗口大小
        self.label_text = Label(self.root, text="加-减-乘法练习软件", font=("楷体",15))
        self.label_text.pack()
        self.label_text_start = Label(self.root, text="请点击任意按钮开始", font=("楷体",15),fg="red")
    ...
    def choice_total_num(self):
        ...
        self.wind2.geometry("331x80+450+300")#窗口大小
            ...
            if result == self.resu:
                ...
                if(self.num_now==0):
                    if(self.error_times==0):
                        ...
                        tkinter.messagebox.showinfo(title="恭喜",message="本次练习完毕！共答题 %d 道，其中计算错误 %d 次,继续加油"%(self.num,self.error_times))
                    self.root.destroy()
                self.make_formula()
                self.right_times_count()
                self.gett=1
